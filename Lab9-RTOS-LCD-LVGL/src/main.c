...
void lv_termostato(void) {
    ...
    lv_obj_align_to(btn3, btn2, LV_ALIGN_OUT_RIGHT_MID, 0, -10);
    ...
    lv_obj_align_to(up, btn3, LV_ALIGN_OUT_RIGHT_MID, 50, -10);
    ...
    lv_obj_align_to(down, up, LV_ALIGN_OUT_RIGHT_MID, 0, -10);
    ...
    lv_obj_align(labelSetValue, LV_ALIGN_LEFT_MID, 220 , -30);
    lv_obj_set_style_text_font(labelSetValue, &dseg47, LV_STATE_DEFAULT);
